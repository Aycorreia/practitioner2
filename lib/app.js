...
console.log(document.body); //carrega la pagina i inserta la linea!
...
const name = 'Ayr'; //claudators!! no parenteisis
...
document.body.innerHTML = template; //gestor de depencencies! sino cal importarles tot al document...
